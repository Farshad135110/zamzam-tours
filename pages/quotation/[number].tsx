  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50" style={{ paddingTop: '100px' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingBottom: '3rem' }}>
          {/* Header */}
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between py-2 border-b border-gray-200 gap-2">
                <span className="text-sm sm:text-base text-gray-700">
                  Tour Package ({quotation.num_adults} Adult{quotation.num_adults > 1 ? 's' : ''}
                  {quotation.num_children > 0 && ` + ${quotation.num_children} Child${quotation.num_children > 1 ? 'ren' : ''}`})
                </span>
                <span className="font-semibold text-sm sm:text-base whitespace-nowrap">{quotation.currency} {quotation.base_price.toFixed(2)}</span>
              </div>

              {quotation.accommodation_upgrade > 0 && (
                <div className="flex justify-between py-2 border-b border-gray-200 gap-2">
                  <span className="text-sm sm:text-base text-gray-700">Accommodation Upgrade ({quotation.accommodation_type})</span>
                  <span className="font-semibold text-sm sm:text-base whitespace-nowrap">{quotation.currency} {quotation.accommodation_upgrade.toFixed(2)}</span>
                </div>
              )}
              ...
              {quotation.discount_amount > 0 && (
                <div className="flex justify-between py-2 border-b border-gray-200 text-green-600">
                  <span className="font-semibold">Discount ({quotation.discount_percentage}%)</span>
                  <span className="font-semibold">- {quotation.currency} {quotation.discount_amount.toFixed(2)}</span>
                </div>
              )}

              <div className="flex flex-col sm:flex-row justify-between py-4 bg-emerald-50 px-4 rounded-lg gap-2">
                <span className="text-lg sm:text-xl font-bold text-gray-900">TOTAL TOUR COST</span>
                <span className="text-xl sm:text-2xl font-bold text-emerald-600">{quotation.currency} {quotation.total_amount.toFixed(2)}</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2 gap-2">
                  ...
                  <span className="text-lg sm:text-xl font-bold text-blue-600 whitespace-nowrap">{quotation.currency} {quotation.deposit_amount.toFixed(2)}</span>
                </div>
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2 gap-2">
                  ...
                  <span className="text-lg sm:text-xl font-bold text-purple-600 whitespace-nowrap">{quotation.currency} {quotation.balance_amount.toFixed(2)}</span>
                </div>
                <p className="text-sm text-gray-600">
              ...
              <div className="mt-4">
                <p className="font-semibold text-gray-900 mb-2">Accepted Payment Methods:</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {!isExpired && quotation.status !== 'accepted' && (
                <button
                  ...
                  className="bg-emerald-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-emerald-700 font-bold text-base sm:text-lg transition-colors"
                >
              ...
              <a
                ...
                className="bg-green-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-green-600 font-bold text-base sm:text-lg text-center transition-colors"
              >
                💬 Chat on WhatsApp
              </a>
              ...
              <button
                ...
                className="border-2 border-gray-300 text-gray-700 px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-gray-50 font-semibold text-base transition-colors"
              >
                📄 Download PDF
              </button>
              ...
              <a
                ...
                className="border-2 border-gray-300 text-gray-700 px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-gray-50 font-semibold text-base text-center transition-colors"
              >
                ✉️ Email Us
              </a>
            </div>
          ...
          {/* Contact Info */}
          <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg shadow-lg p-6 sm:p-8 print-section">
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-3">Need Help?</h3>
              <p className="text-emerald-100 mb-6">Our team is here to assist you!</p>
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 text-sm sm:text-base flex-wrap">
                <a href="mailto:reservation@zamzamlankatours.com" className="flex items-center gap-2 hover:text-emerald-200 transition-colors">
                ...
                >
                  <span className="text-xl">💬</span>
                  <span className="font-semibold">WhatsApp: +94 70 188 8993</span>
                </a>
              </div>
            </div>
          </div>
      ...
      {showAcceptModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Accept Quotation</h2>
